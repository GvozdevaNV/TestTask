...
namespace Task1_Orders
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ThreadPool.QueueUserWorkItem(UpdateOrderPrimary);
            ThreadPool.QueueUserWorkItem(UpdateOrderSecondary);
        ...
        private static void UpdateOrderPrimary(object state)
        {
        ...
        private static void UpdateOrderSecondary(object state)
        {
            using (OrderContext db = new OrderContext())
            {
